...
class InputStyles {
  ...
  static OutlineInputBorder createOutlineBorder({
    Color color = customGreyColor400, double width = 1, double radius = 24,
  }) {
  ...
  static InputDecoration get baseUnderlineDecoration {
    ...
    final activeBorder = createUnderlineBorder(inumPrimary, 2);
    return InputDecoration(
      contentPadding: const EdgeInsets.symmetric(vertical: 12, horizontal: 8),
      errorStyle: const TextStyle(fontSize: 0, height: 0),
      enabledBorder: regularBorder, focusedBorder: activeBorder,
      errorBorder: regularBorder, focusedErrorBorder: activeBorder,
    );
  }

  static InputDecoration get baseOutlineDecoration {
    final regularBorder = createOutlineBorder();
    final activeBorder = createOutlineBorder(color: inumPrimary, width: 1.5);
    return InputDecoration(
  ...
  static InputDecoration searchInputDecoration({
    ...
    return baseOutlineDecoration.copyWith(
      ...
      focusedBorder: createOutlineBorder(color: inumPrimary, radius: 16),
